module datapath(clk, rst, datapath_signals, immediate_data, reg0_out, reg1_out, reg2_out, reg3_out);
    input clk, rst;
    ...
    assign reg0_out = R0_Q;
    assign reg1_out = R1_Q;
    assign reg2_out = R2_Q;
    assign reg3_out = R3_Q;
