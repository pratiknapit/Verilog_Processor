            ...
            8'h00 : 
                begin 
                    casez(operation)
                        ...
                        4'hA : n_state <= 8'h15; // brsh (21)
                        4'hB : n_state <= 8'h17; // load (29)
                        4'hC : n_state <= 8'h19; // store
                        // 4'hB : n_state <= 8'h11; // load
                        // 4'hC : n_state <= 8'h11; // load
                        // 4'hD : n_state <= 8'h11; // load
                        // 4'hE : n_state <= 8'h11; // load
                        // 4'hF : n_state <= 8'h11; // load
